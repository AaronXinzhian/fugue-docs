#!/usr/bin/env python3
"""
[INPUT]: 依赖 Python3 标准库 (sys, os, json); 同目录 geb_check 模块
...
工作方式:
- 仅当会话目录存在 PROJECT_INDEX.md(即项目已采用协议)时才检查,
  其他项目零打扰。
...
from geb_check import run_checks  # noqa: E402
...
def main():
    ...
    if not os.path.isfile(os.path.join(cwd, "PROJECT_INDEX.md")):
